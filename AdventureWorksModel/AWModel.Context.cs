...
namespace AdventureWorksModel
{
    ...
    public partial class AWEntities : DbContext
    {
        ...
        public virtual ObjectResult<OrderDetails_Result> OrderDetails(Nullable<int> orderid)
        {
            var orderidParameter = orderid.HasValue ?
                new ObjectParameter("orderid", orderid) :
                new ObjectParameter("orderid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<OrderDetails_Result>("OrderDetails", orderidParameter);
        }
